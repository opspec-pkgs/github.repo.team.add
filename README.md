[![build](https://github.com/opspec-pkgs/github.repo.team.add/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/github.repo.team.add/actions/workflows/build.yml)
